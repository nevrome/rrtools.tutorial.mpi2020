...
A research compendium contains relevant information to make the **scientific process** behind a book, book chapter or journal article **more transparent** and **reproducible**. Ideally it contains all **data**, **code** and **text** necessary to compile the published document.
