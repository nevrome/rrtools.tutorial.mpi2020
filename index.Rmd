...
<div>
[RMarkdown](https://rmarkdown.rstudio.com/) is an advanced implementation of Markdown that allows to combine text and code. It adds the possibility to add chunks of code that run when the document is rendered.
</div>
<div>
`r astro()``r rocket()`
</div>
