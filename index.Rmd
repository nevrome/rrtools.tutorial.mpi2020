...
take a look at the `paper.Rmd` file, render it with the `Knit` button of RStudio and inspect the resulting `.docx` file
...
edit `./analysis/paper/paper.Rmd` to include our analysis in a R code chunk
